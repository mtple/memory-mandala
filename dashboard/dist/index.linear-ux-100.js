(function () {
  ...
  function DataWorkbench({ graph, layout, counts, totalNodes, kindFilter, setKindFilter, query, setQuery, termFocus, clearTerm, openTerm, pinNode, pinConnection }) {
    ...
    return e("aside", { className: "mm-workbench", "aria-label": "memory data workbench" },
      ...
      e("div", { className: "mm-filter-row" },
        ...
        KINDS.map((kind) => e("button", { key: kind, className: `${kind} ${kindFilter === kind ? "active" : ""}`, onClick: () => setKindFilter(kind) }, KIND[kind].label, e("b", null, counts[kind] || 0)))
      ),
  ...
  function FullscreenMandala({ structure, save, saving, state }) {
    ...
    return e("div", { className: "mm-fullscreen", onMouseLeave: () => setHover(null) },
      ...
      e(DataWorkbench, { graph, layout, counts, totalNodes, kindFilter, setKindFilter, query, setQuery, termFocus, clearTerm: () => setTermFocus(null), openTerm, pinNode, pinConnection }),
      ...
      e("svg", { className: "mm-psy-svg", viewBox: "0 0 1000 1000", role: "img", "aria-label": "fullscreen geometric mandala of evidence-backed memory connections" },
        ...
        layout.links.map((conn) => {
          ...
          return e("g", { key: conn.id, className: `mm-link ${alive ? "alive" : "dim"} ${linkVisible(conn) ? "" : "filtered"}`, onMouseMove: (evt) => setHover(connItem(conn, evt)), onClick: (evt) => setPinned(connItem(conn, evt)) },
