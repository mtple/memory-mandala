(function () {
  ...
  function MemoryMap({ structure, selected, hovered, setSelected, setHovered }) {
    ...
    return e("div", { className: "mm-map-wrap" },
      e("svg", { viewBox: "0 0 720 720", className: "mm-map-svg", role: "img", "aria-label": "Interactive living map of agent memory" },
        ...
        e("circle", { cx, cy, r: 74, className: "mm-core" }),
  ...
  function DomainInspector({ section, insights }) {
    if (!section) return null;
    return e(Card, { className: `mm-inspector ${section.status}` },
      ...
      section.items && section.items.length ? e("div", { className: "mm-evidence-list" },
        section.items.map((item, idx) => e("button", { key: idx, className: "mm-evidence-item", title: item.text },
          e("code", null, item.source),
          e("span", null, item.text)
        ))
      ) : e("p", { className: "mm-gap-copy" }, section.recommendation),
      e("div", { className: "mm-insight-strip" },
        (insights.takeaways || []).slice(0, 2).map((item, idx) => e("button", { key: idx, className: `mm-mini-insight ${item.kind}` },
  ...
  function DomainRail({ structure, selected, setSelected }) {
  ...
  function RelationshipPanel({ structure, setSelected }) {
    ...
    return e(Card, { className: "mm-relationships" },
      ...
      edges.length ? edges.map((edge, idx) => e("button", { className: "mm-edge-row", key: idx, onClick: () => setSelected(edge.from) },
  ...
  function MemoryMandalaPage() {
    ...
    return e("div", { className: "mm-page" },
      ...
      e("section", { className: "mm-live-summary" },
        e("div", null, e("span", null, "coverage"), e("strong", null, `${Math.round((summary.coverage || 0) * 100)}%`), e("em", null, summary.coverage_label || "unknown")),
        e("div", null, e("span", null, "mapped"), e("strong", null, `${summary.present_sections || 0}/6`), e("em", null, "memory domains")),
        e("div", null, e("span", null, "primary gap"), e("strong", null, summary.primary_gap || "none"), e("em", null, "next useful memory")),
        e("div", null, e("span", null, "skills"), e("strong", null, summary.total_skills || 0), e("em", null, "procedures installed"))
      ),
      e("main", { className: "mm-stage" },
        e("div", null,
          e(MemoryMap, { structure, selected, hovered, setSelected, setHovered }),
          e(DomainRail, { structure, selected, setSelected })
        ),
        e("aside", { className: "mm-side" },
          e(DomainInspector, { section: selectedSection, insights }),
          e(RelationshipPanel, { structure, setSelected })
        )
      ),
